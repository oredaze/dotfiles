...
if g:colors_name == "red_dwarf"
  ...
  let s:N3 = airline#themes#get_highlight2(['String', 'fg'], ['StatusLineNC', 'bg'], '')
  let s:Nmod = airline#themes#get_highlight2(['Statement', 'fg'], ['StatusLineNC', 'bg'], '')
  ...
  let s:I1 = airline#themes#get_highlight2(['Normal', 'bg'], ['Number', 'fg'], 'bold')
  let s:I2 = airline#themes#get_highlight2(['Constant', 'fg'], ['Folded', 'bg'])
  let s:I3 = airline#themes#get_highlight2(['Statement', 'fg'], ['StatusLineNC', 'bg'])
  ...
  let s:R1 = airline#themes#get_highlight2(['Normal', 'bg'], ['Statement', 'fg'], 'bold')
  ...
  let s:A1 = airline#themes#get_highlight2(['Normal', 'fg'], ['StatusLineNC', 'bg'], 'bold')
  let s:A2 = airline#themes#get_highlight2(['LineNR', 'fg'], ['Folded', 'bg'], 'bold')
  let s:A3 = airline#themes#get_highlight2(['Normal', 'fg'], ['Folded', 'bg'], 'bold')
  ...
  let s:T2 = airline#themes#get_highlight2(['Normal', 'bg'], ['String', 'fg'], 'bold')
  let s:T3 = airline#themes#get_highlight2(['Folded', 'fg'], ['Folded', 'bg'])
  let s:T4 = airline#themes#get_highlight('StatusLineNC')
  let s:T5 = airline#themes#get_highlight2(['LineNR', 'fg'], ['Folded', 'bg'])
  let s:T6 = airline#themes#get_highlight2(['Normal', 'bg'], ['String', 'fg'], 'bold')
  let s:T7= airline#themes#get_highlight2(['Normal', 'bg'], ['String', 'fg'], 'bold')
  ...
  let s:P1 = airline#themes#get_highlight2(['Normal', 'fg'], ['StatusLineNC', 'bg'], 'NONE')
  let s:P2 = airline#themes#get_highlight2(['Normal', 'fg'], ['Folded', 'bg'])
  let s:P3 = airline#themes#get_highlight2(['Normal', 'bg'], ['String', 'fg'], 'bold')
  ...
  let s:N2 = airline#themes#get_highlight2(['Folded', 'fg'], ['Folded', 'bg'], '')
  let s:N3 = airline#themes#get_highlight2(['String', 'fg'], ['StatusLineNC', 'bg'], '')
  let s:Nmod = airline#themes#get_highlight2(['Constant', 'fg'], ['StatusLineNC', 'bg'], '')
  let g:airline#themes#copycat#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
  let g:airline#themes#copycat#palette.normal_modified = {
        \ 'airline_c': s:Nmod
        \ }
  ...
  let s:I2 = airline#themes#get_highlight2(['Constant', 'fg'], ['Folded', 'bg'])
  let s:I3 = airline#themes#get_highlight2(['Constant', 'fg'], ['StatusLineNC', 'bg'])
  let g:airline#themes#copycat#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
  let g:airline#themes#copycat#palette.insert_modified = g:airline#themes#copycat#palette.normal_modified
  ...
  let s:A1 = airline#themes#get_highlight2(['LineNR', 'fg'], ['StatusLineNC', 'bg'], 'bold')
  let s:A2 = airline#themes#get_highlight2(['LineNR', 'fg'], ['Folded', 'bg'], 'bold')
  let s:A3 = airline#themes#get_highlight2(['LineNR', 'fg'], ['Folded', 'bg'], 'bold')
  let g:airline#themes#copycat#palette.inactive = airline#themes#generate_color_map(s:A3, s:A2, s:A1)
  let g:airline#themes#copycat#palette.inactive_modified = {
        \ 'airline_c': s:A1
        \ }
